...
const ConversationSimulator = () => {
    ...
    // Stats State (merged from other branch)
    ...
    const grantRewards = (success) => {
        ...
        const reward = calculateRewards('conversation', {
            baseXp: activeScenario.xpReward || 50,
            difficulty: activeScenario.difficulty || 1,
            mistakes,
            steps: stepsTaken,
            success
        });
                        ...
                        <div className="grid gap-3">
                            <AnimatePresence mode="wait">
                                {!showOptions && !challengeMode ? (
                                    ...
                                    /* Hybrid Input Mode (shown when options are ready OR in challenge mode) */
                                    <div className="space-y-4">
                                        ...
                                        {(showLegacyOptions || challengeMode === false) && (
                                            <motion.div

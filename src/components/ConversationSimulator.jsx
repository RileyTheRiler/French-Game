...
const ConversationSimulator = () => {
    ...
    const grantRewards = (success) => {
        ...
        // Use calculateRewards utility if available, otherwise manual calculation
        const reward = calculateRewards ? calculateRewards('conversation', {
            baseXp: activeScenario.xpReward,
            difficulty: activeScenario.difficulty === 'Easy' ? 1 : activeScenario.difficulty === 'Medium' ? 2 : 3,
            mistakes,
            steps: stepsTaken,
            success
        }) : {
            xp: success ? activeScenario.xpReward : 5,
            coins: success ? 10 : 0
        };

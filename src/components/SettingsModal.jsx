...
const SettingsModal = ({ onClose }) => {
    const {
        ...
        resetProgress, difficultySettings, updateDifficultySettings,
        stats, updateStats, globalDifficulty, setGlobalDifficulty
    } = useProgress();
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="bg-slate-900 border border-white/10 p-8 rounded-3xl max-w-md w-full shadow-2xl relative max-h-[85vh] overflow-y-auto"
                ...
                ref={dialogRef}
            >
                <div className="flex justify-between items-center mb-8 sticky top-0 bg-slate-900 z-10 py-2">

...
const PronunciationCoach = () => {
    ...
    const { addXP, addCoins, updateDailyStat, incrementStat, stats, offlineAudio, markWordStrength } = useProgress();
    ...
    const checkPronunciation = (heard) => {
        ...
        // Also get simple phoneme feedback for visual fallback
        const { feedback } = scorePronunciation(currentWord.french, heard);
        ...
        setTimeout(() => {
            if (analysis.score >= 70) {
                ...
                const xpGain = analysis.score >= 90 ? 20 : 10;
            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[calc(100vh-200px)] py-8">
                ...
                <Card className="w-full max-w-2xl p-8 bg-slate-900 border-white/10 shadow-2xl flex flex-col items-center text-center relative overflow-hidden">
                    ...
                    <div className="relative w-full flex flex-col items-center z-10">
                        ...
                        <div className="mt-8 min-h-[100px] flex flex-col items-center justify-center w-full">

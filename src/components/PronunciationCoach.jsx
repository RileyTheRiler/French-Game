...
const PronunciationCoach = () => {
    ...
    const { addXP, addCoins, updateDailyStat, incrementStat, offlineAudio, markWordStrength, stats } = useProgress();
    ...
    const checkPronunciation = (heard) => {
        ...
        // Use the advanced PronunciationAnalyzer if available, otherwise simple score
        let analysis;
        try {
             ...
             analysis = { score: accuracy, phonemeBreakdown: [], feedback: {} };
        }

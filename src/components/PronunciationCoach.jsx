...
const PronunciationCoach = () => {
    ...
    const { addXP, addCoins, markWordStrength, incrementStat, updateDailyStat, stats, offlineAudio } = useProgress();
    ...
    const handleNext = () => {
        if (currentWordIndex < wordsToPractice.length - 1) {
            ...
            incrementStat && incrementStat('pronunciationPractices', successCount);

...
const PronunciationCoach = () => {
    ...
    const { addXP, markWordStrength, addCoins, incrementStat, stats } = useProgress();
    ...
    const handleNext = () => {
        if (currentWordIndex < wordsToPractice.length - 1) {
            ...
            }) : { xp: successCount * 10, coins: successCount * 5 };
    ...
    const playExample = () => {
        playWordAudio(currentWord, { preferCache: true });
    };

    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
            <div className="glass-panel w-full max-w-lg p-6 relative h-[80vh] flex flex-col">
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 text-white/50 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded-lg p-1"
                                        ...
                                        <div className="flex justify-between items-start gap-3">
                                            ...
                                            <div className="text-right flex flex-col items-end gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`transition-all hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded p-1 ${word.isSaved ? 'text-amber-400' : 'text-white/20 hover:text-amber-200'}`}

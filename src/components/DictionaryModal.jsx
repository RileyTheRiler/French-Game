...
const VocabItem = React.memo(({ word, now, offlineAudio, toggleSaveWord, togglePinWord, snoozeWord, clearSnooze }) => {
...
const DictionaryModal = ({ onClose, initialSearchTerm = '' }) => {
    ...
    }, [vocabulary, searchTerm, activeTab]);

    const filteredGrammar = useMemo(() => {
        if (activeTab !== 'grammar') return [];
        return GRAMMAR_TIPS.filter(tip =>

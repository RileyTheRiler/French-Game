                                        ...
                                        <div className="flex justify-between items-start gap-3">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        aria-label={`Hear pronunciation for ${word.french}`}
                                                    >
                                                        <Volume2 size={14} />
                                                    </button>
                                                </div>
                                            ...
                                            <div className="text-right flex flex-col items-end gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`transition-all hover:scale-110 ${word.isSaved ? 'text-amber-400' : 'text-white/20 hover:text-amber-200'} focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 rounded-full p-1`}

    ...
    return (
        ...
        >
            <div className="glass-panel w-full max-w-lg p-6 relative h-[80vh] flex flex-col">
                ...
                {/* Tabs */}
                <div className="flex space-x-2 mb-6 bg-white/5 p-1 rounded-xl" role="tablist" aria-label="Resource categories">
                    <button
                        ...
                        aria-controls="dictionary-content-panel"
                        id="tab-vocab"
                    >
                        Dictionary
                    </button>

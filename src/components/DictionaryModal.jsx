    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
            <div className="glass-panel w-full max-w-lg p-6 relative h-[80vh] flex flex-col">
                <button aria-label="Close" onClick={onClose} className="absolute top-4 right-4 text-white/50 hover:text-white transition-colors">
                                        ...
                                        <div className="flex justify-between items-start gap-3">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button aria-label="Play audio" onClick={() => playWordAudio(word, { preferCache: true, offlineOnly: offlineAudio })} className="p-1.5 rounded-full bg-white/5 hover:bg-white/10 text-indigo-300 border border-white/10 transition-colors">
                                                        <Volume2 size={14} />
                                                    </button>
                                                </div>

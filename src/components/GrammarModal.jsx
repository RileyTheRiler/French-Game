                            ...
                            <div className="flex gap-1" role="tablist" aria-label="Grammar tips navigation">
                                {GRAMMAR_TIPS.map((_, idx) => (
                                    <button
                                        ...
                                        aria-label={`View grammar tip ${idx + 1} of ${GRAMMAR_TIPS.length}`}
                                        onClick={() => setCurrentIndex(idx)}
                                        className={`w-2 h-2 rounded-full transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${idx === currentIndex ? 'bg-emerald-500 w-6' : 'bg-slate-700 hover:bg-slate-600'
                                            }`}
                                    />
                                ))}
                            </div>

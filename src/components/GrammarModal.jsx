                ...
                >
                    <Card className="p-0 border-white/10 shadow-3xl overflow-hidden">
                        ...
                        <div className="p-6 border-t border-white/10 flex justify-between items-center">
                            ...
                            <div className="flex gap-1" role="tablist" aria-label="Pagination">
                                {GRAMMAR_TIPS.map((_, idx) => (
                                    <button
                                        ...
                                        className={`w-2 h-2 rounded-full transition-all outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${idx === currentIndex ? 'bg-emerald-500 w-6' : 'bg-slate-700 hover:bg-slate-600'
                                            }`}
                                    />
                                ))}
                            </div>

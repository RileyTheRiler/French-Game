            ...
            <div className="p-4 border-t border-white/10 bg-slate-900/50">
                <div className="flex items-center gap-2">
                    <div className="flex-1 relative">
                        ...
                        />
                        <button aria-label="Use microphone" className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-violet-400 transition-colors">
                            <Mic size={20} />
                        </button>
                    </div>
                    <Button aria-label="Send message" onClick={handleSend} disabled={!message.trim()} className="h-12 w-12 rounded-full p-0">
                        <Send size={20} />
                    </Button>
                </div>
            </div>

...
const FallingWordsGame = () => {
    ...
    const { getPracticeQueue, markWordSeen, getDueWords, updateWordProgress, getWeightedPracticeWords, vocabulary, CATEGORIES } = useVocabulary();
    const {
        stats,
    ...
    useEffect(() => {
        ...
        try {
            ...
            const words = (queue && queue.length) ? queue : (weighted && weighted.length ? weighted : getDueWords());
    ...
    const grantSessionRewards = useCallback(() => {
        ...
        const reward = calculateRewards('fallingWords', {
            ...
            maxCombo,
            wordsCaught,
            livesRemaining: isZenModeRef.current ? 3 : 1, // Dummy value
        ...
        <GameLayout
            ...
            headerRight={
                <div className="flex items-center gap-4">
                    ...
                    <Badge variant="primary" className="text-lg py-1 px-4" data-testid="score-display">

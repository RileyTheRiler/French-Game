...
const FallingWordsGame = () => {
    ...
    useEffect(() => {
        ...
        try {
            // Priority: Weighted Practice -> Due Words -> Vocabulary
            const weighted = getWeightedPracticeWords ? getWeightedPracticeWords(40) : null;
            let words = weighted && weighted.length ? weighted : getDueWords();

            if (!words || words.length === 0) {
                 words = getPracticeQueue ? getPracticeQueue('fallingWords', 40) : [];
            }

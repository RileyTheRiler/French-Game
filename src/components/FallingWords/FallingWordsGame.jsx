...
const FallingWordsGame = () => {
    ...
    const { getDueWords, updateWordProgress, getWeightedPracticeWords, vocabulary, markWordSeen } = useVocabulary();
    const { logWordAttempt, globalDifficulty, difficultySettings, updateDailyStat } = useProgress();
    ...
    }, [getDueWords, getWeightedPracticeWords, vocabulary]);

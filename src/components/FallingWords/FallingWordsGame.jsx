...
const FallingWordsGame = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const finalWords = (weighted && weighted.length) ? weighted : (words && words.length ? words : getDueWords());
    ...
    const grantSessionRewards = useCallback(() => {
        ...
        const reward = calculateRewards('fallingWords', {
            ...
            maxCombo,
            wordsCaught,
            livesRemaining: 3, // Assuming lives aren't tracked here yet, pass default
    ...
    const gameLoop = (time) => {
        ...
        // Also consider global difficulty

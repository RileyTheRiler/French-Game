...
const WordItem = memo(({ text, x, y, isMatched, mastery, lastSeen, hint, spawnTime, hintDelay = 8 }) => {
    ...
    useEffect(() => {
        ...
        // If spawnTime is provided (which it should be), calculate remaining time
        if (spawnTime) {

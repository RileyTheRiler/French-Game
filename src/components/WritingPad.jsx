                ...
                <div className="flex items-center justify-center gap-2">
                    {STROKE_COLORS.map(color => (
                        <button
                            ...
                            className={`w-8 h-8 rounded-full border-2 transition-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-white ${strokeColor === color.value
                ...
                <div className="flex items-center justify-center gap-3">
                    {STROKE_WIDTHS.map(width => (
                        <button
                            ...
                            className={`flex items-center justify-center w-10 h-10 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 ${strokeWidth === width
                                ? 'bg-purple-500'

    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-950">
            ...
            <div className="px-4 mb-4">
                <div className="flex bg-slate-800/50 rounded-xl p-1 max-w-md mx-auto" role="tablist" aria-label="Practice Mode">
                    <button
                ...
                <div className="flex items-center justify-center gap-2" role="group" aria-label="Stroke color">
                    {STROKE_COLORS.map(color => (
                        <button
                            ...
                            className={`w-8 h-8 rounded-full border-2 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-purple-400 ${strokeColor === color.value

        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-950">
            ...
            <div className="p-4 flex items-center justify-between">
                <button
                    ...
                    className="p-2 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 focus-visible:ring-2 focus-visible:ring-purple-400 focus:outline-none transition-colors"
                >
            ...
            <div className="px-4">
                <div className="relative bg-slate-800 rounded-2xl border-2 border-slate-700 overflow-hidden">
                    ...
                    <button
                        ...
                        className="absolute top-3 right-3 z-10 p-2 rounded-lg bg-slate-700/80 hover:bg-slate-600/80 focus-visible:ring-2 focus-visible:ring-purple-400 focus:outline-none transition-colors"
                    >
                        {showGuide ? (
                ...
                <div className="flex items-center justify-center gap-2">
                    {STROKE_COLORS.map(color => (
                        <button
                            ...
                            className={`w-8 h-8 rounded-full border-2 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-purple-400 focus:outline-none transition-transform ${strokeColor === color.value
                ...
                <div className="flex items-center justify-center gap-3">
                    {STROKE_WIDTHS.map(width => (
                        <button
                            ...
                            className={`flex items-center justify-center w-10 h-10 rounded-lg focus-visible:ring-2 focus-visible:ring-purple-400 focus:outline-none transition-colors ${strokeWidth === width
                                ? 'bg-purple-500'

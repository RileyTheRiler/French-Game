...
const GrammarDrill = () => {
    ...
    const nextDrill = () => {
        if (currentIndex + 1 >= drills.length) {
            ...
            addXP(reward.xp + sessionPoints);
            addCoins(reward.coins);
            incrementStreak(); // Global streak
                    ...
                    <AnimatePresence>
                        {showResult && (
                            ...
                            >
                                ...
                                {/* Grammar Insight - Always shown after answering if available */}
                                {relatedTip && (
                                    <GrammarInsightCard
                                        tip={relatedTip}

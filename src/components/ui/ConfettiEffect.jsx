...
const ConfettiEffect = ({
    ...
    useEffect(() => {
        if (!active) {
            // setTimeout to avoid synchronous state update warning if active prop changes during render
        ...
        const newParticles = Array.from({ length: particleCount }, (_, i) => ({
            ...
            shape: Math.random() > 0.5 ? '50%' : '2px', // Moved random shape generation to state
        }));

    ...
    return (
        <div id="main-content" tabIndex={-1} className="min-h-screen relative p-4 md:p-8 flex flex-col items-center max-w-7xl mx-auto">
            ...
            <div className="absolute top-4 right-4 flex gap-2 z-10">
                <LanguageSwitcher />
                <Button variant="ghost" size="sm" onClick={() => setShowLeaderboard(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.leaderboard")}>
                    <Trophy size={20} className="text-yellow-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowSocial(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.social")}>
                    <Users size={20} className="text-violet-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowDictionary(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.dictionary")}>
                    <Book size={20} className="text-blue-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowSettings(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.settings")}>
                    <Settings size={20} className="text-slate-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowShop(true)} className="rounded-full h-12 w-12 p-0 relative" aria-label={t("menu.shop")}>
                ...
                <Button variant="ghost" size="sm" onClick={() => setShowAchievements(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.achievements")}>
                    <Award size={20} className="text-orange-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowGrammar(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.grammar")}>
                    <BookOpen size={20} className="text-emerald-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => navigate('/mastery')} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.mastery")}>
                    <BarChart3 size={20} className="text-indigo-400" />
                </Button>
                <Button variant="ghost" size="sm" onClick={() => setShowGoals(true)} className="rounded-full h-12 w-12 p-0" aria-label={t("menu.goals")}>

...
const StatsModal = ({ isOpen, onClose }) => {
    ...
    const { vocabulary, getAllCategories } = useVocabulary();
    ...
    // const categoryPerformance = stats?.categoryPerformance || {}; // Used in Remote, but HEAD has different structure
    ...
    // Category Accuracy (HEAD style)
    const categoryStats = Object.entries(stats.categoryStats || {}).map(([cat, data]) => ({
        name: cat,

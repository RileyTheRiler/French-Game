...
import { X, TrendingUp, Book, Flame, Trophy, Clock, Target, BarChart3, Calendar, AlertCircle, Coins } from 'lucide-react';
                        ...
                        <div className="p-6 border-b border-white/10 flex justify-between items-center bg-gradient-to-r from-indigo-500/20 to-violet-500/20 shrink-0">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="bg-amber-500/10 border border-amber-500/20 px-3 py-1.5 rounded-xl flex items-center gap-2">
                                    ...
                                    <span className="font-bold text-amber-400">{formatNumber(stats.coins || 0)}</span>
                                </div>

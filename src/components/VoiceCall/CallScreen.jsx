        ...
        <div id="main-content" tabIndex={-1} className="flex flex-col h-full bg-slate-900 relative overflow-hidden">
            ...
            <div className="pb-12 pt-8 flex items-center justify-center gap-8 z-10 bg-gradient-to-t from-slate-900 to-transparent">
                ...
                <button
                    ...
                    className={`w-16 h-16 rounded-full flex items-center justify-center transition-all transform hover:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:outline-none ${isUserListening
                ...
                <button
                    onClick={onEndCall}
                    aria-label="End call"
                    className="w-16 h-16 rounded-full bg-red-600 hover:bg-red-500 text-white flex items-center justify-center shadow-lg transition-all transform hover:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none"
                >
                    <PhoneOff size={28} />
                </button>
            </div>

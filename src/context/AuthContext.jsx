...
export const AuthProvider = ({ children }) => {
    ...
    // Bolt Optimization: Memoize the context value to prevent unnecessary cascading re-renders
    // of all consuming components whenever the AuthProvider re-renders (e.g., from state changes).
    const value = useMemo(() => ({
        user,
        loading,
        error,

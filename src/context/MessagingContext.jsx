...
// Simulate partner typing and response
    const simulatePartnerResponse = useCallback((partnerId, userMessage) => {
        ...
        setTimeout(() => {
            ...
            // Simple response generation based on partner personality (mocked for now)
            const responseText = partner.greeting || "Bonjour ! Comment ça va ?";
            ...
            setConversations(prev => {
                ...
                return {
                    ...prev,
                    [partnerId]: [...existing, responseMessage]
                };
            });

            // Mark conversation as unread if user is not currently viewing it
            // (Handled by checking active chat component in UI)
        }, randomDelay);
    }, []);

...
export const MessagingProvider = ({ children }) => {
    ...
    const simulatePartnerResponse = useCallback((partnerId, userMessage) => {
        ...
        setTimeout(() => {
            ...
            // Detect errors in user's message
            const errors = detectErrors(userMessage, partner);

            // Include correction if partner is 'strict' or found major errors
            let finalResponse = responseText;
            if (errors && partner.personality === 'strict') {
                finalResponse = `Correction: "${errors.correction}". ${responseText}`;
            }
            ...
            setConversations(prev => ({
                ...prev,
                [partnerId]: [...(prev[partnerId] || []), messageObj]
            }));

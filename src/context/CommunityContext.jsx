...
export const CommunityProvider = ({ children }) => {
    ...
    // ⚡ Bolt Optimization: Memoized context value to prevent unnecessary re-renders in all consumers
    // Impact: Avoids cascading updates across community components when unrelated state changes occur
    const value = useMemo(() => ({
        myWritings,
        pendingWritings,
        myCorrections,

        ...
        setTimeout(() => {
            ...
            setMyWritings(prev => prev.map(w => {
                if (w.id === writingId) {
                    return {
                        ...w,
                        corrections: [...(w.corrections || []), ...mockCorrections],
                        comments: [...(w.comments || []), { id: Date.now(), author: 'NativeSpeakerBot', text: overallComment }],
                        status: 'corrected'
                    };
                }
                return w;
            ...
            console.log(`Your writing (ID: ${writingId}) has been corrected!`);

            // Give XP for getting corrected
            addXP(5);
        }, delay);
    }, [addXP]);

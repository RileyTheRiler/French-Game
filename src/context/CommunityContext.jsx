...
export const CommunityProvider = ({ children }) => {
    ...
    // ⚡ Bolt: Memoize context value to prevent unnecessary re-renders in community components
    // Impact: Avoids re-rendering heavy lists of writings and corrections when irrelevant state changes
    const value = useMemo(() => ({
        myWritings,
        pendingWritings,
        myCorrections,

...
export const SocialProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        setActiveChallenge(prev => {
            const isCompleted = total >= prev.target;
            if (prev.current === total && prev.isCompleted === isCompleted) {
                return prev; // Prevent unnecessary state updates that trigger the linter
            }
            return {
                ...prev,
                current: total,

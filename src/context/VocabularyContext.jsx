...
export const VocabularyProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        // Debounce synchronous localStorage.setItem to avoid blocking main thread during frequent word progress updates
    ...
    // Ensure data isn't lost if the user leaves the page before the debounce timer fires
    useEffect(() => {

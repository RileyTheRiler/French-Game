...
export const VocabularyProvider = ({ children }) => {
    ...
    const contextValue = useMemo(() => ({
        ...
        getPracticeQueue,
        downloadAudioOnce
    }), [vocabulary, getDueWords, getWeightedPracticeWords, updateWordProgress, toggleSaveWord, addCustomWord, customDecks, createDeck, updateDeck, deleteDeck, getDeckWords, addWordToDeck, removeWordFromDeck, exportDeck, importDeck, markWordSeen, togglePinWord, snoozeWord, clearSnooze, getPracticeQueue]);

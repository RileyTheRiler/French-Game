...
export const ProgressProvider = ({ children }) => {
    ...
    const contextValue = useMemo(() => ({
        ...
        incrementStat, checkAchievements, activateDoubleXP, isDoubleXpActive, updateDailyStat,
        hydrateProgress, completeOnboarding, applyPlacementResult, setTargetCefr, setWeeklyGoal,
        setModeDifficulty, recordCategoryPerformance, logWordAttempt, updateUserGoals,
        updateDifficultySettings, updateDailyXPGoalFn, trackConversationSession,
        logConceptAttempt, getWeakConceptsList, setLearningProfile, setGlobalDifficulty,
        ...
        updateCognitiveState, logDreamGoal, updateMemoryPalaceRoom, markWeeklyRecapSeen,
        markWordStrength, addToReviewQueue, removeFromReviewQueue, getWeeklySummary
    ]);

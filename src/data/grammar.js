export const GRAMMAR_TIPS = [
    ...
    },
    {
        ...
        whyItMatters: 'Using the wrong form can be seen as disrespectful (too formal with friends) or rude (too informal with superiors). This social nuance is crucial in French culture.',
        commonMistakes: [

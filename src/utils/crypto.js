 ...
 * @param {string} storedHash - The stored hash (salt:hash) or legacy plaintext password.
...
export async function verifyPassword(storedHash, password) {
    ...
    return timingSafeEqual(originalHashHex, newHashHex);
}
 ...
 * Note: Length leakage is still possible but acceptable for fixed-length hashes.
 */

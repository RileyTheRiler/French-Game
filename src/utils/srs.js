...
export const sortByReviewPriority = (words) => {
    ...
    // Optimize sort by pre-calculating priorities (Schwartzian transform)
    // This avoids recalculating retention probability (which uses Math.exp) multiple times per item during sort
    return words
        .map(word => {

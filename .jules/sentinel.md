...
## 2024-05-01 - JSON Parsing Vulnerability
**Vulnerability:** Unprotected `JSON.parse` on user-uploaded files.
**Learning:** Malformed external JSON can cause unhandled exceptions and crashes.
**Prevention:** Wrap `JSON.parse` in `try...catch` and validate the result is a non-null object.

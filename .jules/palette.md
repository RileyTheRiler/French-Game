...
## 2025-05-16 - Icon-Only Button Accessibility Pattern
**Learning:** Many icon-only buttons in the main navigation (e.g., Top Bar Actions) lack basic accessibility attributes like aria-labels, and tooltips for sighted users.
**Action:** Whenever reviewing or updating interactive icon components, explicitly add both accessibility labels for screen readers and tooltips to preserve hover information.

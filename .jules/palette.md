...
## 2024-04-24 - Accessible Visual Selectors
**Learning:** Custom interactive visual controls (like color swatches or size selectors) lack inherent meaning to screen readers and often present redundant visual information.
**Action:** Explicitly add accessible labels and pressed state attributes to the interactive container elements, apply keyboard focus styles, and hide their internal decorative elements to ensure clear navigation without redundant announcements.

...
## 2024-05-26 - Accessible Custom Indicators
**Learning:** When using custom mapped buttons for navigation or pagination indicators (like dots), they need semantic grouping and individual accessible labels with current state indicators to be usable by screen readers.
**Action:** Always wrap indicator collections in a grouping element with a descriptive label, and ensure each indicator button has a descriptive label and an active state indicator.

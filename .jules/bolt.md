...
## 2024-05-24 - React Context Memoization
**Learning:** Unmemoized context value objects cause unnecessary re-renders in consumer components.
**Action:** Use useMemo to memoize context values and carefully manage the dependency array.

...
## 2024-05-24 - VocabularyContext Sync Storage Blocking
**Learning:** Just like ProgressContext, VocabularyContext was writing large JSON arrays to browser storage on every state change, blocking the main thread.
**Action:** Debounced browser storage writes in all high-frequency context providers and added event listeners to flush state on page exit to prevent data loss.
